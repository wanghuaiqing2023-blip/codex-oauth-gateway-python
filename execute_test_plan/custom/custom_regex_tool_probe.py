...
RESPONSE_JSON_PATH = OUTPUT_DIR / "custom_regex_tool_response.json"

TOOL_NAME = "ticket_id"
REGEX_DEFINITION = r"^[A-Z]{3}-[0-9]{4}$"
EXPECTED_INPUT = "BUG-1024"
PROMPT = (
    "Call the ticket_id custom tool. The tool input must be exactly BUG-1024. "
...
CUSTOM_REGEX_TOOL = {
    "type": "custom",
    "name": TOOL_NAME,
    "description": "Accepts exactly one ticket id in the form AAA-1234.",
    "format": {
        "type": "grammar",
        "syntax": "regex",
...
def main() -> int:
    ...
    print(f"regex_definition: {REGEX_DEFINITION}")
    print("scope: protocol probe only; this script does not execute the returned value")
    ...
    print_table(
        ...
        [
            [
                ...
                elapsed_ms,
                bool(re.fullmatch(REGEX_DEFINITION, observed_input)),
