...
INCLUDE_VALUE = "web_search_call.action.sources"
...
def main() -> int:
    ...
    print("intent: verify whether Codex backend returns web search action sources with the Codex CLI web_search tool shape")
    ...
    matches = find_key_values(payload, "sources")
