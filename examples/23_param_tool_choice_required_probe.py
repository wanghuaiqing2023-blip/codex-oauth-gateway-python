...
def main() -> int:
    ...
    print("intent: verify whether Codex backend accepts tool_choice=required and forces a tool call")
    ...
    print_probe_result(status, "request succeeded with explicit tool_choice=required")
    return 0
