...
def main() -> int:
    ...
    print("intent: verify whether Codex backend accepts tool_choice=none and suppresses tool calls")
    print("Codex CLI note: public ResponsesApiRequest includes tool_choice")
    ...
    status = "accepted_without_tool_call" if not used_tool else "accepted_but_tool_was_used"
    ...
    print_probe_result(status, "request succeeded with explicit tool_choice=none")
    return 0
