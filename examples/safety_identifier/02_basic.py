...
CASE = "safety_identifier_basic"
EXPECTED_TEXT = "safety-identifier-probe-ok"
...
SAFETY_IDENTIFIER = "gateway-safety-probe-user-001"
...
def main() -> int:
    ...
    print(f"safety_identifier: {SAFETY_IDENTIFIER}")
    ...
    if EXPECTED_TEXT in output_text:
        status = "supported"
        observation = "request accepted with safety_identifier"
    else:
