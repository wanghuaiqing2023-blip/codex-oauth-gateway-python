...
CASE = "background_true_with_stream"
...
def main() -> int:
    ...
    if EXPECTED_TEXT in collected_text:
        status = "supported_with_stream_output"
        observation = "background=true and stream=true request returned streamed output"
    else:
        status = "accepted_without_stream_output"
        observation = "request accepted but expected streamed output was not observed"
