...
def main() -> int:
    ...
    try:
        ...
        status = "supported" if used_web_search else "accepted_without_observed_tool_call"
    ...
    print("case: tool_choice_allowed_tools_object")
    ...
    print("intent: verify whether allowed_tools object form can require a limited tool set")
