...
FUNCTION_TOOL = {
    "type": "function",
    "name": TOOL_NAME,
    "description": "Return a deterministic value for the gateway tool_choice probe.",
    "strict": True,
    "parameters": {
        "type": "object",
...
def main() -> int:
    ...
    try:
        ...
        function_calls = find_objects_by_type(payload, "function_call")
        ...
        status = "supported" if function_calls else "accepted_without_observed_tool_call"
        observation = "found function_call" if function_calls else "request accepted; no function_call observed"
    ...
    print("case: tool_choice_function_object")
    ...
    print("tool: function get_probe_value")
    print("intent: verify whether tool_choice can force a named function tool call")
