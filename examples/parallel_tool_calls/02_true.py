...
def main() -> int:
    ...
    print("intent: verify whether Codex backend accepts parallel_tool_calls=true with a tool call")
    ...
    print_probe_result(status, "request succeeded with parallel_tool_calls=true")
    return 0
